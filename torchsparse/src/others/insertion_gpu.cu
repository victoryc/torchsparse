...
__global__ void insertion_grad_kernel(int N, int c, int s,
...
void insertion_wrapper(int N, int c, int s, const float *data, const int *idx,
                       const int *counts, float *out) {
  insertion_kernel<<<N, c>>>(N, c, s, data, idx, counts, out);
}

void insertion_grad_wrapper(int N, int c, int s, const float *top_grad,
                            const int *idx, const int *counts,
                            float *bottom_grad) {
